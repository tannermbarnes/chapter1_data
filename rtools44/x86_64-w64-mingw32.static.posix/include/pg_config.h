...
#define CONFIGURE_ARGS " '--host=x86_64-w64-mingw32.static.posix' '--build=x86_64-pc-linux-gnu' '--prefix=/usr/lib/mxe/usr/x86_64-w64-mingw32.static.posix' '--enable-static' '--disable-shared' 'ac_cv_prog_HAVE_DOXYGEN=false' '--enable-doc=no' '--enable-gtk-doc=no' '--enable-gtk-doc-html=no' '--enable-gtk-doc-pdf=no' '--docdir=/root/mxe/tmp-postgresql-x86_64-w64-mingw32.static.posix/postgresql-13.14.build_.sink' '--infodir=/root/mxe/tmp-postgresql-x86_64-w64-mingw32.static.posix/postgresql-13.14.build_.sink' '--mandir=/root/mxe/tmp-postgresql-x86_64-w64-mingw32.static.posix/postgresql-13.14.build_.sink' '--with-html-dir=/root/mxe/tmp-postgresql-x86_64-w64-mingw32.static.posix/postgresql-13.14.build_.sink' '--disable-doxygen' '--disable-rpath' '--without-tcl' '--without-perl' '--without-python' '--without-gssapi' '--without-krb5' '--without-pam' '--without-ldap' '--without-bonjour' '--with-openssl' '--without-readline' '--without-ossp-uuid' '--without-libxml' '--without-libxslt' '--with-zlib' '--with-system-tzdata=/dev/null' 'CFLAGS=-DSSL_library_init=OPENSSL_init_ssl' 'LIBS=-lsecur32 -lssl -lz -lws2_32 -lgdi32 -lcrypt32 -lcrypto -lz -lws2_32 -lgdi32 -lcrypt32 -lpthread ' 'ac_cv_func_getaddrinfo=no' 'build_alias=x86_64-pc-linux-gnu' 'host_alias=x86_64-w64-mingw32.static.posix'"
...
#define PACKAGE_STRING "PostgreSQL 13.14"
...
#define PG_VERSION "13.14"

/* PostgreSQL version as a number */
#define PG_VERSION_NUM 130014

/* A string containing the version number, platform, and C compiler */
#define PG_VERSION_STR "PostgreSQL 13.14 on x86_64-w64-mingw32.static.posix, compiled by x86_64-w64-mingw32.static.posix-gcc (GCC) 13.2.0, 64-bit"
